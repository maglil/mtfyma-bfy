...
\input{parts/goals-intro}

\input{chapters/mission}
\input{chapters/vision}
\input{chapters/mtfyma-specializations}
\input{chapters/bfy-specializations}
\input{chapters/msphys-specializations}
\input{chapters/learning-outcomes}

% Overordnet målsetning.
%\include{section/program-descriptions}
% Beskrivelse av egenarten til programmene.

%\include{section/competencies}

%\include{section/digital-skills}
%\include{section/experimental-skills}
...
\input{appendix/external-reports/external-reports}

\input{appendix/external-reports/eps-specification-bachelor.tex}:

\input{appendix/external-reports/aapt-computational-physics}

\input{appendix/external-reports/asa-guidelines.tex}
